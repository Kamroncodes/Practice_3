const PassageArray_raw = [
    ...
    {type: "practice",
     ...
     exercise: "cloze_example",
        ...
        instructions: ["Match the words to the correct translation",],
        example_sentences: ["He was relieved he finished on time.", "You could tell by his poor posture that he was nervous.", "We made eye_contact and said hello.", "The audience waited quielty for the show to start.", "The presentation was boring becasue I couldn't hear the speaker."],
        vocabulary_wordlist: ["presentation", "relieved", "nervous", "posture", "audience", "eye_contact", ],
        review_button: "Check Answers",
    },
    {type: "practice",
